...
const Favorite = () => {
  ...
  return (
    <section className="pt-4 pb-8  min-h-screen bg-services">
      <h2 className=" uppercase text-orange font-bold text-center">
        favorites
      </h2>
        ...
        <div className=" grid grid-cols-2 gap-6 pt-4">
          {details.flags.map((flag, index) => (
            <div key={index} className="shadow-lg bg-services">
              ...
              <h1 className="text-orange capitalize font-bold text-center p-2">
                {details.names[index]}
              </h1>
              <section className="flex justify-between font-bold pb-4 px-2">
                <button
                  ...
                  onClick={(e) => {
                    const parentElement =
                      e.currentTarget.closest("div").children;
                ...
                <button
                  ...
                  onClick={(e) => {
                    ...
                    const value = details.flags.findIndex(
                      (src) => src === flag
                    );
                    ...
                    localStorage.setItem(
                      "restflags",
                      JSON.stringify(details.flags)
                    );
                    localStorage.setItem(
                      "restnames",
                      JSON.stringify(details.names)
                    );
