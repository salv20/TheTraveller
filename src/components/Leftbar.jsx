...
const Leftbar = ({ nav, navFunc }) => {
    return (
        <nav className={` ${!nav ? '-left-eighty' : 'left-0'} fixed w-full md:w-3/4  h-full bg-dawhite px-10 space-y-5 capitalize font-bold py-5  lg:sticky overflow-y-scroll lg:h-screen transition-all duration-700`}>
